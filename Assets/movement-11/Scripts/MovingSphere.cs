...
public class MovingSphere : MonoBehaviour {
	...
	public void SetCommand(CommandMoving command)
	{
...
//	{
//		if (!Swimming)
//			desiresClimbing = flag;
//	}

	public void UpdateInput()
	{
		playerInput.x = command.direction.x;
		playerInput.z = command.direction.z;
		playerInput.y = Swimming ? command.direction.y : 0f;
		...
		if (Swimming) {
			...
			desiredJump |= command.jump;
			desiresClimbing = command.clamp;
		}

		UpdateBall();
//		command = new CommandMoving(); // 默认值覆盖掉;
	}
